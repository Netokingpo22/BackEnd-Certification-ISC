...
def actividadAprendizaje_api_view(request):
    ...
    if request.method == 'GET':
        ...
        actividadesASerializers = actividadAprendizajeSerializers(actividadesAprendizaje, many=True)
        return Response(actividadesASerializers.data)
    
    elif request.method == 'POST':
        actividadesASerializers = actividadAprendizajeSerializers(data=request.data)
...
def actividadesEnseñanza_api_view(request):
    ...
    if request.method == 'GET':
        ...
        actividadesESerializers = actividadEnseñanzaSerializers(actividadesEnseñanza, many=True)
        return Response(actividadesESerializers.data)
    
    elif request.method == 'POST':
        actividadesESerializers = actividadEnseñanzaSerializers(data=request.data)
...
def competenciaGenerica_api_view(request):
    ...
    if request.method == 'GET':
        ...
        competenciaGSerializers = competenciaGenericaSerializers(competenciaGenerica, many=True)
        return Response(competenciaGSerializers.data)
    
    elif request.method == 'POST':
        competenciaGSerializers = competenciaGenericaSerializers(data=request.data)
...
def instrumentoEvaluacion_api_view(request):
    ...
    if request.method == 'GET':
        ...
        instrumentoESerializers = instrumentoEvaluacionSerializers(instrumentoEvaluacion, many=True)
        return Response(instrumentoESerializers.data)
    
    elif request.method == 'POST':
        instrumentoESerializers = instrumentoEvaluacionSerializers(data=request.data)
